                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="{{route('direktur.delete',$user['id'])}}" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
            ...
            <form action="{{ route('direktur.save') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama" name="name" placeholder="Enter Name" required>
                    </div>
